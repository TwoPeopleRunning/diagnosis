...
var schema = new Schema({
  ...
  MNTNAME: { type: String, default: '' },
  SVRNAME: { type: String, default: '' },
  SVRIP: { type: String, default: '' },
  MNTDESC: { type: String, default: '' },
  EXPAND: { type: String, default: '' },
  SVRPORT: { type: Number, required: true },
},{collection:"MDC_MNT"});
...
module.exports = mongoose.model('MDC_MNT', schema);
